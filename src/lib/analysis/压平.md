...
<div data-sunwayTheme='light' style="height:60vh">
  <EpsplanetEarth :showDefaultBasemap="true" @onReady="ready">
    <EpsplanetButton container="#earthContainer" icon="icon-tool_kjcx" type="panel" :position="position" :panel="panel" title='压平分析'>
      <EpsplanetFlatten/>
    </EpsplanetButton>
  </EpsplanetEarth>
</div>
